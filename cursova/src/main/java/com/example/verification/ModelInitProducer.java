...
public class ModelInitProducer {
    ...
    //                                 truck4St.getServed());
    //             };
    //             Supplier<Double> mean_wait_q = () -> (smoSt.getWaitTime() + smoD.getDoneTime()) / smoD.getServed();

    //             // ResultCalculator calc = new ResultCalculator(

    //             // );

    //             return Pair.createPair(model, null);
    //         };
    //     };
    // }
}
