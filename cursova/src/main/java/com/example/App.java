...
public class App 
{
    ...
    {
        // var model = new Model(baseModelInit);

        // var statsSaver = new StatsSaver();

        // for (int i = 0; i < N_SAMPLES; i++) {
        //     statsSaver.addStats(model.simulate(1000));
        // }
    ...
    static CompDeviceWithCooldown newTruckProcess(String name) {
        return new CompDeviceWithCooldown(
            FunRand.getCombined(List.of(FunRand.getNotNullNorm(22, 10), FunRand.getUniform(2, 8))), 
