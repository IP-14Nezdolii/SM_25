...
public class BaseStatsSaver {
    private final String filename;
    private final ArrayList<Pair<BaseResultCalculator, Integer>> statsBuffer = new ArrayList<>();

    public BaseStatsSaver(String filename) {
    ...
    public void addStats(BaseResultCalculator stat, int testMask) {
        this.statsBuffer.add(Pair.createPair(stat, testMask));
    }

    public void addStats(ArrayList<Pair<BaseResultCalculator, Integer>> buff) {
    ...
    private void writeBufferToSheet(Sheet sheet, int startRowIndex) {
        ...
        for (Pair<BaseResultCalculator, Integer> pair : statsBuffer) {
            BaseResultCalculator data = pair.get0();
