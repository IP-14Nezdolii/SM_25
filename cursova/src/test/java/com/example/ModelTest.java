...
public class ModelTest {
	...
	public void modModelTest() {
		...
		connection2.addNext(loader1, () -> {
			...
			if (truck4.getChannelState().isReady() && rest14.getChannelState().isDone()) 
				countB++;
			if (truck5.getChannelState().isReady() && rest15.getChannelState().isDone()) 
				countB++;
		...
		connection3.addNext(truck5, () -> {
			return rest15.getChannelState().isDone();
		});
		...
		restCon15.addNext(rest15, () -> truck5.getChannelState().isDone());
